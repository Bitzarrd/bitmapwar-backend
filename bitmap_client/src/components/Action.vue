...
<template>
  <div class="combg">
    <div class="titc com_flex3"><img src="images/ico4.png"/><em>Action</em></div>
    <ul class="act_form">
      <li><em>Function:</em>
        <div class="ck_c com_flex1"><span class="cur"><i class="ibg ibg1"></i></span><span><i
            class="ibg ibg2"></i></span><span><i class="ibg ibg3"></i></span><span><i
            class="ibg ibg4"></i></span></div>
      </li>
      <li><em>Bitmap:</em>
        <p>818888</p></li>
      <li><em>Owner:</em>
        <p>0x86d...c8319</p></li>
      <li><em>Soldier:</em><input class="a_intxt" type="text" value="100"/></li>
    </ul>
    <div class="act_bot"><input type="button" value="Submit" class="submit"/></div>
  </div>
<!--  <div class="mycard">-->
