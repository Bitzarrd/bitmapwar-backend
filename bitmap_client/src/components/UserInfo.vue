  ...
  <div class="mycard">
    <el-card class="box-card">
      ...
      <el-form label-width="70px" v-if="wallet_address">
        ...
        <el-form-item label="Freeclaim">
          <el-input disabled placeholder="500 Soldier" style="float: left;display: inline;width: 110px;margin-right: 10px"/>
          ...
          <ShareNetwork
              ...
              hashtags="vuejs,vite"
          >
            <el-button  style="float: right;display: inline">
              <el-icon color="white" class="no-inherit">
                <Share/>
              </el-icon>
            </el-button>
